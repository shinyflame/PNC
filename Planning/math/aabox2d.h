...
void AABox2dTest_GetAllCorners();
void AABox2dTest_CenterAndLengths();
void AABox2dTest_HasOverlap();
void AABox2dTest_DistanceTo();
void AABox2dTest_IsPointIn();
void AABox2dTest_IsPointOnBoundary();
void AABox2dTest_MinMax();
void AABox2dTest_Shift();
void AABox2dTest_MergeFrom();
