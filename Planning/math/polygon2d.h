...
void Polygon2dTest_polygon_IsPointIn();
void Polygon2dTest_DistanceToPoint();
void Polygon2dTest_DistanceToLineSegment();
void Polygon2dTest_DistanceToPolygon();
void Polygon2dTest_ContainPolygon();
void Polygon2dTest_ConvexHull();
void Polygon2dTest_Overlap();
void Polygon2dTest_BoundingBox();
void Polygon2dTest_Expand() ;
