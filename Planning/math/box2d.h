 ...
 * the world "heading" in this project (permanently set to be 0 at East)
...
class Box2d {
 public:
  ...
  void InitCorners();
  void ExtendInLength(double forwards,double rearwards);
...
void Box2dTest_DebugString();
void Box2dTest_GetAllCorners();
void Box2dTest_CenterAndLength();
void Box2dTest_HasOverlap();
void Box2dTest_GetAABox();
void Box2dTest_DistanceTo();
void Box2dTest_IsPointIn();
void Box2dTest_IsPointOnBoundary();
void Box2dTest_RotateFromCenterAndShift();
void Box2dTest_TestByRandom();
