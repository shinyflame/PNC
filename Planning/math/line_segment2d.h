...
void LineSegment2dTest_Accessors() ;
void LineSegment2dTest_DistanceTo();
void LineSegment2dTest_GetPerpendicularFoot();
void LineSegment2dTest_ProjectOntoUnit();
void LineSegment2dTest_GetIntersect();
void LineSegment2dTest_IsPointIn() ;
