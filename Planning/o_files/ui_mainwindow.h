...
public:
    ...
    QPushButton *Slow_Forward;
    QLineEdit *record_speed;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(0, 0, 1141, 831));
        ...
        groupBox->setGeometry(QRect(1340, 80, 141, 121));
        Fast_Forward = new QPushButton(groupBox);
        Fast_Forward->setObjectName(QStringLiteral("Fast_Forward"));
        Fast_Forward->setGeometry(QRect(10, 20, 121, 25));
        Slow_Forward = new QPushButton(groupBox);
        Slow_Forward->setObjectName(QStringLiteral("Slow_Forward"));
        Slow_Forward->setGeometry(QRect(10, 50, 121, 25));
        record_speed = new QLineEdit(groupBox);
        record_speed->setObjectName(QStringLiteral("record_speed"));
        record_speed->setGeometry(QRect(10, 80, 121, 25));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Fast_Forward->setText(QApplication::translate("MainWindow", "Fast Forward", nullptr));
        Slow_Forward->setText(QApplication::translate("MainWindow", "Slow Forward", nullptr));
    } // retranslateUi
